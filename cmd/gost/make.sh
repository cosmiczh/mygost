...
CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=6 go build -o gost-linux-armv6
# gost-linux-armv7 适应华硕AC86U路由器
echo gost-linux-armv7
CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=7 go build -o gost-linux-armv7
# gost-linux-arm64
echo gost-linux-arm64
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -o gost-linux-arm64
